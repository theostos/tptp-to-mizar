...
class MirzaDataModule(FineTuningDataModule, IOMixin):
...
def mirza(model_name, **kwargs) -> run.Config[pl.LightningDataModule]:
    return run.Config(MirzaDataModule, **kwargs)
